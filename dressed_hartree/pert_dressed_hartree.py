...
def iterative_perturbation(SigDMFT1,SigDMFT2,U,T,nfreq,order,maxit=100):
    '''
    ...
    #prepare diagrams in terms of G_DMFT. In current algorithm they are calculated just only once.
