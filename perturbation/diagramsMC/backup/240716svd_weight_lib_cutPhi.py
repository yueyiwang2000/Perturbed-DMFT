...
class meassureWeight:
    ...
    """
    def __init__(self,Ndimk, Ndimtau,knum,taunum,Ndimind):
        # self.Nbin = Nbin
        ...
        self.integral0 =  knum**(3*(self.Ndimk))*taunum**(self.Ndimtau)*2**(self.Ndimind)# integration of trial fm, which is f0
