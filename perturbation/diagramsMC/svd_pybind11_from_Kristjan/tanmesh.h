...
void GiveDoubleExpMesh0(bl::Array<double,1>& x/*, bl::Array<double,1>& dx*/, double a, double b, int Nx, double al=2.1){
  for (int i=0; i<Nx; i++){
...
void GiveDoubleExpMesh(bl::Array<double,1>& tau, bl::Array<double,1>& tau_dh, double beta, int Ntau_)
{
  double al=2.1;
  tau.resize(Ntau_);
  tau_dh.resize(Ntau_);
